...
struct DiscoveryByRatingView: View {
    ...
    private var onOptionSelected:
        ((_ _option: GenreFilterDropdownOptionDomainModel) -> Void)? = {
            option in
...
struct DiscoveryContent: View {
    ...
    @State private var selectedOption: GenreFilterDropdownOptionDomainModel? =
        nil
