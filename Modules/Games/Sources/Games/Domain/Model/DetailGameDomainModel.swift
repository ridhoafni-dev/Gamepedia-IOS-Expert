...
public struct DetailGameDomainModel: Equatable, Identifiable {
    ...
    public init(
        ...
        reviewsCount: Int?,
        parentPlatforms: [PlatformDomainModel]?,
        platforms: [DetailPlatformDomainModel]?,
        stores: [StoreDetailsDomainModel]?,
        developers: [DeveloperInDetailGameDomainModel]?,
        genres: [GenreInDetailsDomainModel]?,
        tags: [TagDomainModel]?,
        publishers: [PublisherDomainModel]?,
