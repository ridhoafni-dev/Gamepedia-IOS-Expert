...
public class DetailGameTransformer {
  ...
  private static func mapBasicProperties(
    ...
    destination.originalName = source.originalName ?? "Unknown Original Name"
    ...
    destination.backgroundImageAdditional = source.backgroundImageAdditional ?? ""
  ...
  private static func mapDevelopers(
    ...
    let devs = (source.developers ?? []).map { developer -> DeveloperInDetailsModuleEntity in
